<template>
	<view class="content">
		...
		<view class="cu-list grid col-3" :style="{marginTop: CustomBar + 'px'}">
			<view class="cu-item" v-for="(item, index) in icon" v-key v-if="item.isShow">
				<text :class="'cuIcon-' + item.name"></text>
				<text>{{item.name}}</text>
			</view>
		</view>
	</view>
