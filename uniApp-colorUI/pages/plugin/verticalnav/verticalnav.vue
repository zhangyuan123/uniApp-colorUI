<template>
	<view class="content">
		...
		<swiper class="screen-swiper round-dot" :indicator-dots="true" :autoplay="true" :interval="5000" :duration="500">
			<swiper-item v-for="(item, index) in 4" v-key>
				<image :src="'https://image.weilanwl.com/img/4x3-'+ (index+1) + '.jpg'" mode="aspectFill"></image>
			</swiper-item>
		</swiper>
		<view class="VerticalBox">
			<scroll-view class="VerticalNav nav" scroll-y scroll-with-animation :scroll-top='VerticalNavTop' style="height:calc(100vh - 375rpx)">
				<view class="cu-item" :class="index == TabCur ? 'text-green cur' : ''" v-for="(item, index) in list" v-key :data-id='index'
				 @click="tabSelect">
					Tab-{{item.name}}
				</view>
			</scroll-view>
			<scroll-view class="VerticalMain" scroll-y scroll-with-animation style="height:calc(100vh - 375rpx)"
			 :scroll-into-view="'main-' + MainCur" @scroll="VerticalMain">
				<view class="padding-top padding-lr" v-for="(item, index) in list" v-key :id="'main-' + index">
