		...
		<view class="cu-timeline">
			...
			<view class="cu-item text-blue">
				...
				<view class="content bg-cyan">
					<text>21:00</text> 【银河系】快件已到达银河系，准备发往月球
				</view>
			</view>
		</view>
		<view class="cu-timeline">
			<view class="cu-time">03-02</view>
			<view class="cu-item">
				<view class="content">
					<text>02:30</text> 【喵星】 MX-12138 已揽收，准备发往银河系
				</view>
			</view>
		</view>
		<view class="cu-timeline">
				...
				<view class="content bg-blue shadow-blur">
					<view class="cu-list menu-avatar radius">
						<view class="cu-item">
							...
							<view class="action">
								<view class="text-grey text-xs">22:00</view>
								<view class="cu-tag round sm bg-grey">5</view>
							</view>
						</view>
						<view class="cu-item">
